    ...
    if language is not None:
        main = div_prefix + main + \
            ('\n' + '<h2>Data</h2>\n' +
                ...
                '\n<div id="error-link-div">Please report any errors in the data <a href="https://docs.google.com/forms/d/e/1FAIpQLSdYU88YCezA3zgDpkR_8XmEJdmodMSRNWmsZRmwNtXskujbrA/viewform">here</a>.'
