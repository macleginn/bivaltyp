...
ABL — ablative; ADEL — adelative; ADR — addressee case; AOR — aorist; ATTR — attributive; COP — copula; DAT — dative; DIR — directive; ERG — ergative; F — feminine; GEN — genitive; H — human; HAB — habitual; IMP — imperative; INEL — inelative; INESS — inessive; INS — instrumental; IPF — imperfective; LAT — lative; M — masculine; N — neuter; NEG — negation; OBL — oblique; PF — perfective; PL — plural; PN — person name; PRF — perfect; PRS — present; PTCP — participle; REFL — reflexive; SEQ — sequential; SUPER — superessive; SUPEREL — superelative.
