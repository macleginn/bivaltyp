const fullData = [
  ...
  [
    ...
    "‘And Tantalus fears the big stone hanging in the air.’",
    ...
    "‘И боится Тантал камня большого, висящего в воздухе.’",
    "",
    ""
  ],
  [
  ...
  [
    ...
    "TR",
    "TR",
    "(aconit-um) morde-t stomach-um et cor affic-i-t",
  ...
  [
    ...
    "three.NOM.PL leader(M)-NOM.PL quarrell-PRS.PTCP.ACT-NOM.PL all_but CONJ leave-PRF.SBJV.ACT-3PL other-NOM.PL from other-ABL.PL from_three_sides army(M)-ACC.SG in remote-SUP-ACC.PL.F region(F)-ACC.PL divide[PRF.IND]-ACT.3PL",
  ...
  [
    ...
    "disappear[PRS.IND]-ACT.3SG but red-lead(N)-NOM.SG in water(F)-ABL.SG ",
  ...
  [
    ...
    "‘Мне вас хватает.’",
    "Context: children ask their mother for a little brother. She answers.",
    "",
    "",
    "",
    ""
