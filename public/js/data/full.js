const fullData = [
  ...
  [
    ...
    "PN reach[PST.3SG.M] towards Miriam",
    "‘Pinchas caught up with Menachem’",
    "",
    "",
    "",
    "",
  ...
  [
    ...
    "Miriam dream[PTCP]-SG.F on PN",
    "‘Menachem dreams about Pinchas’",
    "",
    "",
    "",
    "",
  ...
  [
    ...
    "PN upset[PST.3SG.M] much Miriam",
    "‘Pinchas greatly upset Menachem’",
    "",
    "",
    "",
    "",
  ...
  [
    ...
    "Y",
    "NOM_sINS",
    "Pet-ja deret-sja s Maš-ej",
    "PN(M)-NOM.SG fight(IPFV)-REFL with PN(F)-INS.SG",
    "‘Petja is fighting with Maša’",
    "",
    "PN(M)-NOM.SG драться(IPFV)-REFL с PN(F)-INS.SG",
    "‘Петя дерется с Машей.’",
    "драться",
    "Пет-я дерет-ся с Маш-ей"
  ],
  [
    "Russian",
    "be_friends",
  ...
  [
    ...
    "X",
    "DAT_NOM",
    "Pet-e nravit-sja èt-a rubašk-a",
    "PN(M)-DAT.SG please(IPFV)-REFL this-F.NOM.SG shirt(F)-NOM.SG",
    "‘Petja likes this shirt.’",
    "",
    "PN(M)-DAT.SG нравиться(IPFV)-REFL этот-F.NOM.SG рубашка(F)-NOM.SG",
    "‘Пете нравится эта рубашка.’",
    "нравиться",
    "Пет-е нравит-ся эт-а рубашк-а"
  ],
  [
    "Russian",
    "need",
  ...
  [
    ...
    "Y",
    "NOM_izGEN",
    "Pet-ja pokinu-l rodn-oj gorod",
    "PN(M)-NOM.SG leave(PFV)-PST[M.SG] native-M.ACC.SG city(M)[ACC.SG]",
    "‘Petja left his native city.’",
    "",
    "PN(M)-NOM.SG покинуть(PFV)-PST.M.SG родной-M.ACC.SG город(M)[ACC.SG]",
    "‘Петя покинул родной город.’",
    "покинуть",
    "Пет-я покину-л родн-ой город"
  ],
  [
    "Russian",
    "cover",
  ...
  [
    ...
    "PN(NOM) PV-1.be.similar.IPFV-CVB=be PN-OBL-CONT",
    "‘Rasul resembles Ramazan.’",
    "",
    "PN(NOM) PV-1.быть.похожим.IPFV-CVB=быть PN-OBL-CONT",
  ...
  [
    ...
    "PN(NOM) PV-RE-1.catch.up.PFV-CVB=be PN-POST",
    "‘Rasul caught up with Samira.’",
    "",
    "PN(NOM) PV-RE-1.догнать.PFV-CVB=быть PN-POST",
    "‘Расул догнал Самиру.’",
    "",
    ""
  ],
  ...
  [
    ...
    "PN(NOM) wall-OBL-CONT PV-1.touch.PFV-CVB",
    "‘Rasul touched the wall.’",
    "",
    "PN(NOM) стена-OBL-CONT PV-1.касаться.PFV-CVB",
  ...
  [
    ...
    "PN-ERG PN-CONT-EL thought 3-do.IPFV-CVB=be",
    "‘Rasul is thinking about Samira.’",
    "",
    "PN-ERG PN-CONT-EL мысль 3-делать.IPFV-CVB=быть",
  ...
  [
    ...
    "PN-ERG PN-OBL-POST sound <3>do.PFV-CVB",
    "‘Rasul called Ramazan.’",
    "",
    "PN-ERG PN-OBL-POST звук <3>делать.PFV-CVB",
  ...
  [
    ...
    "PN-OBL-POST car(NOM) be-CVB 3-COP",
    "‘Rasul has a car.’",
    "",
    "PN-OBL-POST машина(NOM) быть-CVB 3-COP",
  ...
  [
    ...
    "PN-OBL-CONT dog.OBL-ERG tooth(NOM) PV-4.LV.PFV-CVB",
    "‘A dog bit Rasul.’",
    "",
    "PN-OBL-CONT собака.OBL-ERG зуб(NOM) PV-4.LV.PFV-CVB",
  ...
  [
    ...
    "‘My hands smell of gasoline.’",
    "",
    "I-ATTR рука-PL-OBL.Pl-CONT-EL бензин-ATTR запах(NOM) 4.идти.IPFV-CVB=быть",
    "‘Мои руки пахнут бензином.’",
    "",
    ""
  ],
  ...
  [
    ...
    "PN(NOM) french language.OBL-POST PV-1.understand.IPFV-CVB=be",
    "‘Rasul understands French.’",
    "",
    "PN(NOM) французский язык.OBL-POST PV-1.понимать.IPFV-CVB=быть",
  ...
  [
    ...
    "fire(NOM) house-OBL-CONT PV-4.hit.PFV-CVB",
    "‘Lightning hit the house.’",
    "",
    "огонь(NOM) дом-OBL-CONT PV-4.ударить.PFV-CVB",
    "‘Молния попала в дом.’",
    "",
    ""
  ],
  ...
  [
    ...
    "glass(NOM) table-OBL-CONT PV-PV-<3>stick.PFV-CVB=be",
    "‘The glass got stuck to the table.’",
    "",
    "стакан(NOM) стол-OBL-CONT PV-PV-<3>прилипать.PFV-CVB=быть",
    "‘Стакан прилип к столу.’",
    "",
    ""
  ],
  ...
  [
    ...
    "XY",
    "DAT_POST",
    "rasul-u-s madinat-ɨ-χda c’ihal jiši-r=a",
    "PN-OBL-DAT PN-OBL-POST longing(NOM) 4.become.PFV-CVB=be",
    "‘Rasul misses Madinat.’",
    "",
    "PN-OBL-DAT PN-OBL-POST тоска(NOM) 4.стать.PFV-CVB=быть",
  ...
  [
    ...
    "PN-ERG ear PV-4.listen.IPFV-CVB=be radio-OBL-POST",
    "‘Rasul is listening to radio.’",
    "",
    "PN-ERG ухо PV-4.слушать.IPFV-CVB=быть радио-OBL-POST",
    "‘Расул слушает радио.’",
    "",
    ""
  ],
  [
    ...
    "PN-ERG mother-OBL-POST ear PV-1.listen.IPFV-CVB=be-PST",
    "‘Rasul always obeys his mother.’",
    "",
    "PN-ERG мать-OBL-POST ухо PV-1.слушать.IPFV-CVB=быть-PST",
  ...
  [
    ...
    "PN(NOM) PV-1.look.IPFV-CVB=be cloud-PL.OBL-POST",
    "‘Rasul is looking at the clouds.’",
    "",
    "PN(NOM) PV-1.смотреть.IPFV-CVB=быть облако-PL.OBL-POST",
  ...
  [
    ...
    "PN-ERG gun(NOM) 3-shoot.PFV-CVB=be-PST bird-OBL-POST",
    "‘Rasul shot at the bird.’",
    "",
    "PN-ERG ружье(NOM) 3-стрелять.PFV-CVB=быть-PST птица-OBL-POST",
  ...
  [
    ...
    "",
    "PN-OBL-DAT сердце.OBL-CONT PV-попасть.PFV-CVB=быть PN(NOM)",
  ...
  [
    ...
    "X",
    "DAT_NOM",
    "rasul-u-s qɨ<Ø>ga-r=a čej",
    "PN-OBL-DAT <4>love.IPFV-CVB=be tea(NOM)",
    "‘Rasul loves tea.’",
    "",
    "PN-OBL-DAT <4>любить.IPFV-CVB=быть чай(NOM)",
    "‘Расул любит чай.’",
    "",
    ""
  ],
  ...
  [
    ...
    "PN(NOM) 1.become.mad.PFV-CVB=be PN-OBL-POST",
    "‘Rasul has a grudge against Nadir.’",
    "",
    "PN(NOM) 1.обезуметь.PFV-CVB=быть PN-OBL-POST",
